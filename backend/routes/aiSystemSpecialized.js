...
router.post('/soul/print', asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const soulPrintData = {
      ...
      coreValues: result.data?
      .values || [
        'AuthenticitéSTR_InnovationSTR_Impact positifSTR_Croissance personnelle'
      ]
      lifePurpose :
       result.data?
      .purpose || 'Créer de la valeur en aidant les autres à réaliser leur potentiel'
      spiritualLevel :
       result.data?.spiritual_level || 0.7
      uniqueTraits: result.data?
      .unique_traits || [
...
router.post('/alchemy/transform', asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const alchemyResult = {
      ...
      synergisticOpportunities: result.data?
      .opportunities || [
...
router.post('/hyperloop/launch', asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const hyperLoopPlan = {
      ...
      productivityBoosts: result.data?
      .boosts || [
